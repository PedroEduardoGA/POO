		...
		do{
			...
			if(opcao==2) {
				...
				if(subopcao==0) {
					...
					{
						if(cp.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
				...
				if(subopcao==1) {
						...
						{
							if(cc.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
				...
				if(subopcao==2) {
					...
					{
						if(ci.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
				...
				if(subopcao==0)
				{
					for(int i = 0; i < cp.size(); i++)
					{
						if(cp.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
							...
							System.out.print(" é de R$" +cp.get(i).saldo);
						}
					}	
				}
				...
				if(subopcao==1) {
					for(int i = 0; i < cc.size(); i++)
					{
						if(cc.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
							...
							System.out.print(" é de R$" +cc.get(i).saldo);
						}
					}
				}
				...
				if(subopcao==2) {
					for(int i = 0; i < ci.size(); i++)
					{
						if(ci.get(i).numeroConta.equals(nroConta)) {//compara o nº da conta com o nº passado
							...
							System.out.print(" é de R$" +ci.get(i).saldo);
						}
					}
				}
			}
